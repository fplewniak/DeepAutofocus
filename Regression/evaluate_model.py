...
def get_params(argv):
    ...
    return a.model, a.batch_size, a.image_size, a.title, a.gt, a.crop, a.out_stats, a.out_data
...
if __name__ == '__main__':
    model_name, batch_size, image_size, title, ground_truth_file, crop, out_stats, out_data = get_params(sys.argv[1:])
    print(out_data)
    ...
    test_df = pd.read_csv(ground_truth_file, header=0, names=['filename', 'deltaz'])
